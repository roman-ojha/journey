    ...
    <section className={styles.review_and_rating_container}>
      ...
      <div className={styles.review_and_ratings}>
        {Array.from({ length: 10 }).map((_, i) => (
          <>
            <div className={styles.single_review_and_rating} key={i}>
              <Avatar>
                <Image
              ...
              <div className={styles.single_review_and_rating__content}>
                ...
                <p className={styles.single_review_and_rating__content__review}>
                  ...
                  Voluptas sequi non provident sint, illum quia minus distinctio
                  tenetur animi id magnam beatae suscipit natus est ad doloribus
                  quis dolores soluta.
                </p>
              </div>
            </div>
