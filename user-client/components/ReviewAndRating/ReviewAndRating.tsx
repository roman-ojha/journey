...
const ReviewAndRating = ({
  ...
  // const reviews: ReviewAndRatingType[] = [
  //   {
  //     name: "Alice Johnson",
  //     picture:
    ...
    <section className={styles.review_and_rating_container}>
      ...
      <div className={styles.review_and_ratings}>
        {reviews?.map((review, i) => {
          const userName =
            faker.person.firstName() + " " + faker.person.lastName(); // NOTE: just for temporary uses
          return (
                ...
                >
                  ...
                  >
                    ...
                    {isLoading ? (
                      ...
                      <p>{new Date(review.updated_at).toDateString()}</p>
                    )}
                  </span>
                  <span
                  ...
                  {isLoading ? (
                    ...
                    <p
                      className={
                        styles.single_review_and_rating__content__review
                      }
                    >
                      {review.review}
                    </p>
